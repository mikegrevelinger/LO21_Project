...
void DBManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DBManager::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DBManager::sendError)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void DBManager::sendError(QString _t1)
{
